...
function tinyframework_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'tinyframework_content_width', 1120 );
}
...
function tinyframework_display_credits() {
    ...
    $text .= '1555 Sherman Ave, #173 Evanston, IL 60201';
	$text .= '<span class="meta-separator" aria-hidden="true">&bull;</span>';

    $text .= '(224) 858-OYFF';
	$text .= '<span class="meta-separator" aria-hidden="true">&bull;</span>';

	$text .= ' <a href="http://memohernandez.com" title="Web Development by Guillermo Hernandez" rel="designer">Web Development by Guillermo Hernandez and OYFF</a> ';
	$text .= '<span class="meta-separator" aria-hidden="true">&bull;</span>';
